...
const redemptionItems: RedemptionItem[] = [
  // Airtime
  {
    ...
    name: 'R10 Airtime',
    icon: '📱',
    description: 'Valid on all SA networks (MTN, Vodacom, Cell C, Telkom)',
    category: 'airtime',
    coinCost: 10000,
    value: 'R10',
    comingSoon: false,
  ...
  {
    id: 'gc-takealot-r50',
    name: 'Takealot Gift Card',
    icon: '🎁',
    description: 'R50 Takealot voucher — shop anything online',
    category: 'giftcard',
    coinCost: 50000,
    value: 'R50',
    comingSoon: true,
  ...
  {
    id: 'gc-woolworths-r50',
    name: 'Woolworths Gift Card',
    icon: '🛒',
    description: 'R50 Woolworths gift card — food & fashion',
    category: 'giftcard',
    coinCost: 50000,
    value: 'R50',
    comingSoon: true,
  ...
  // Vouchers
  {
    ...
    name: 'Uber Voucher',
    icon: '🚗',
    description: 'R50 credit valid on Uber rides',
    category: 'voucher',
    coinCost: 50000,
    value: 'R50',
    comingSoon: true,
  ...
  {
    id: 'voucher-electricity',
    name: 'Electricity Token',
    icon: '⚡',
    description: 'R20 prepaid electricity token',
    category: 'voucher',
    coinCost: 20000,
    value: 'R20',
    comingSoon: true,
        ...
        <div className="space-y-3 text-sm text-gray-300">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-gray-400">
                Watch ads, complete tasks, and play games to earn coins
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-gray-400">
                Use coins for entry-level shop items starting at{' '}
                {minimumShopValue}
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold text-white">
                Withdraw After Threshold
              </p>
              <p className="text-gray-400">
                Cash withdrawal requires at least{' '}
