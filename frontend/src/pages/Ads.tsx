          ...
          <Card className="bg-gradient-to-br from-purple-900/40 to-blue-900/40 border-2 border-purple-500/50">
            <div className="text-center py-12">
              ...
              <h2 className="text-3xl font-bold text-white mb-4">
                Watch an Ad & Earn AdCoins
              </h2>
              <p className="text-gray-300 mb-8">
                Watch a short advertisement to earn AdCoins that convert to real
                cash
              </p>

              <div className="bg-yellow-500/20 rounded-lg p-6 mb-8 max-w-md mx-auto">
