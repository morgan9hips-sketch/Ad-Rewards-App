            ...
            <div className="grid md:grid-cols-4 gap-4 mb-4">
              <div className="bg-gray-800 p-4 rounded-lg">
                ...
                <p className="text-sm text-gray-500">
                  R{report.thisMonth.expiredCoins.value.toFixed(2)} (
                  {report.thisMonth.expiredCoins.count} users)
                </p>
              </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-800">
                    ...
                    <th className="text-right py-3 px-2 text-gray-400 font-semibold">
                      Amount
                    </th>
                    <th className="text-right py-3 px-2 text-gray-400 font-semibold">
                      Cash Value
                  ...
                  {balances.map((balance) => (
                    ...
                    >
                      ...
                      <td className="py-3 px-2 text-gray-400 text-sm">
                        {balance.reason === 'coin_inactivity' &&
                          '30 days inactive'}
                        {balance.reason === 'cash_inactivity' &&
                          '90 days inactive'}
                      </td>
                    </tr>
                  ))}
