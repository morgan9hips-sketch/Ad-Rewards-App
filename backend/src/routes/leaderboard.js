...
router.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, leaderboard, formattedLeaderboard, currentUserRank, currentUser, rank, error_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                leaderboard = _b.sent();
                formattedLeaderboard = leaderboard.map(function (profile, index) { return ({
                    rank: index + 1,
            ...
            case 2:
                currentUser = _b.sent();
                if (!(currentUser && currentUser.showOnLeaderboard)) return [3 /*break*/, 4];
            ...
            case 5:
                error_1 = _b.sent();
                console.error('Error fetching leaderboard:', error_1);
